...
const LoginButton: React.FC = () => {
  return (
    <button className="flex overflow-hidden gap-2 justify-center items-center p-4 mt-4 w-full text-base font-semibold leading-loose bg-white rounded-xl border border-solid border-zinc-200 min-w-[100px] text-zinc-800">
      <img
        loading="lazy"
